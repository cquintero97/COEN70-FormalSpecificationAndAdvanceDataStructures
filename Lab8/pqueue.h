...
//     Postcondition: The PriorityQueue becomes copy of another
//
// DESTRUCTOR for the PriorityQueue class:
//   ~PriorityQueue()
//     Postcondition: frees all data
//
...
//   node(
//	   const value_type& init_data = value_type(), unsigned int init_priority = 0, 
//     node* init_link = NULL)
//     Postcondition: The node contains the specified data, link, and priority.
...
namespace coen70_lab8 {
    ...
    private:
        ...
        // The data type Node is completely defined above.
        node *head_ptr;
        size_t many_nodes;
    };

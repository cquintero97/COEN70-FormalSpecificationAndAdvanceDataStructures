...
//
//	 void increaseArray(unsigned int exponent)
//		POSTCONDITION: array size is increased if exponent is larger than 
//		coefficient of array, so that array can fit the exponent.
//
//
// CONSTRUCTOR, DESTRUCTOR, AND COPY CONSTRUCTOR for the polynomial class
...
//
//	 ~polynomial();
//		POSTCONDITION: freed memory used for polynomial array
//
//	 polynomial(const polynomial& other);
//		POSTCONDITION: copy of the polynomial other is created
//
...
//		POSTCONDITION: copies other onto the current focused polynomial
//

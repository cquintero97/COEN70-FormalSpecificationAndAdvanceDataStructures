...
//     Postcondition: The sequence has been intialized as a copy of source
//
// DESTRUCTOR for the sequence class:
//   ~sequence()
//      Postcondition: all nodes of the sequence are deallocated and memory returned to heap
//
...
//     Postcondition: copies source to sequence
//
